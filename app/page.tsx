  ...
  return (
    <>
      <main className="relative min-h-screen overflow-hidden bg-[#F4F7FB] text-[#0B132B]">
        ...
        <div className="pointer-events-none absolute left-1/2 -top-50 h-125 w-125 -translate-x-1/2 rounded-full bg-cyan-400/25 blur-3xl" />
            ...
            <div className="relative mt-24">
              ...
              <div className="space-y-16">
                ...
                <div className="relative grid items-center gap-10 md:grid-cols-2">
                  <div className="rounded-3xl bg-white/70 p-10 shadow-xl backdrop-blur-xl">
                    <p className="text-sm font-semibold uppercase tracking-widest text-[#19C6F4]">
                      Ages 6–8
                    </p>
                    <h3 className="mt-4 text-3xl font-bold">Explorer</h3>
                ...
                <div className="relative grid items-center gap-10 md:grid-cols-2">
                  ...
                  <div className="rounded-3xl border-l-2 border-[#F97316]/20 bg-white/70 p-10 shadow-xl backdrop-blur-xl">
                    <p className="text-sm font-semibold uppercase tracking-widest text-[#F97316]">
                      Ages 9–11
                    </p>
                    <h3 className="mt-4 text-3xl font-bold">Creator</h3>
                    <p className="mt-4 text-lg text-slate-700">
                ...
                <div className="relative grid items-center gap-10 md:grid-cols-2">
                  <div className="rounded-3xl bg-white/70 p-10 shadow-xl backdrop-blur-xl">
                    ...
                    <h3 className="mt-4 text-3xl font-bold">Developer</h3>
                    <p className="mt-4 text-lg text-slate-700">
                ...
                <div className="relative grid items-center gap-10 md:grid-cols-2">
                  ...
                  <div className="rounded-3xl border-l-2 border-[#F97316]/20 bg-white/70 p-10 shadow-xl backdrop-blur-xl">
                    ...
                    <h3 className="mt-4 text-3xl font-bold">Innovator</h3>
                    <p className="mt-4 text-lg text-slate-700">
