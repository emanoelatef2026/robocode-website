  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        />
        <p className={`mt-1 text-right text-[12px] ${message.length < 10 && message.length > 0 ? 'text-[#EF4444]' : 'text-[#64748B]'}`}>
      ...
      <div>
        <label className="mb-1.5 block text-sm font-medium text-[#0B1F3A]">
          Image <span className="text-[13px] font-normal text-[#64748B]">(optional, max 5 MB)</span>
        </label>
