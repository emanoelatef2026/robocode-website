    ...
    <section id="group-health">
      <div className="mb-4 flex items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <span className="rounded-full bg-[#F1F5F9] px-2.5 py-0.5 text-[12px] font-medium text-[#64748B]">
      ...
      {groups.length === 0 ? (
        <div className="rounded-2xl border border-[#E2E8F0] bg-white px-5 py-10 text-center">
          ...
          <p className="mt-1 text-[13px] text-[#94A3B8]">Create a group to get started.</p>
        </div>
      ) : (
