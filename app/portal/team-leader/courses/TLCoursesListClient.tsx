      ...
      <div className="flex items-center justify-between gap-3 mb-5">
        <div>
          ...
          <p className="mt-0.5 text-sm text-[#64748B]">
            {total} course{total !== 1 ? 's' : ''} — business performance view
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="rounded-xl border border-[#E2E8F0] bg-white">
        <div className="flex flex-wrap items-center gap-3 border-b border-[#E2E8F0] px-4 py-3">
          <form method="get" className="flex gap-2">
            ...
            <button
              type="submit"
              className="rounded-xl bg-[#FF8A1F] px-4 py-2 text-sm font-medium text-white hover:bg-[#e87c18]"
            >
              Search
            </button>
            {search && (
              <Link
                ...
                className="rounded-xl px-3 py-2 text-sm text-[#94A3B8] hover:text-[#64748B]"
              >
                Clear
              </Link>
            )}
                ...
                return (
                  <div key={course.id} className="px-4 py-4">
                    <div className="flex items-start justify-between gap-2">
                      <div>
                        <p className="text-[15px] font-semibold text-[#0B1F3A]">{course.title}</p>
                    ...
                    <button
                      ...
                      className="mt-2 text-xs font-medium text-[#FF8A1F] hover:underline"
                    >
                      Edit
                    </button>
                  </div>
