  ...
  return (
    <div className="relative">
      <button
        ...
        aria-expanded={open}
        aria-haspopup="menu"
        className="flex min-h-11 items-center gap-1.5 rounded-lg bg-[#C2410C] px-3 py-1.5 text-[13px] font-semibold text-white hover:bg-[#e87c18] transition"
      >
        Actions
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-full z-50 mt-1 w-52 ds-card py-1 shadow-xl" role="menu">

            {isArchived ? (
              canRecover && onRecover && (
                <button
                  onClick={() => { setOpen(false); onRecover() }}
                  className="flex min-h-11 w-full items-center gap-2.5 px-3.5 py-2.5 text-left text-[13px] font-semibold text-[#1D4ED8] hover:bg-[#EFF6FF] transition"
                >
              ...
              <>
                <button
                  ...
                  className="flex min-h-11 w-full items-center gap-2.5 px-3.5 py-2.5 text-left text-[13px] font-semibold text-[#C2410C] hover:bg-[#FFF7ED] transition"
                >
                  <svg viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 shrink-0">
                ...
                <button
                  ...
                  className="flex min-h-11 w-full items-center gap-2.5 px-3.5 py-2 text-left text-[13px] font-medium text-[#374151] hover:bg-[#F8FAFC] transition"
                >
                ...
                <button
                  ...
                  className="flex min-h-11 w-full items-center gap-2.5 px-3.5 py-2 text-left text-[13px] font-medium text-[#EF4444] hover:bg-[#FEE2E2] transition"
                >
                  <svg viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 shrink-0">
                ...
                {onIssueBulkCertificates && (
                  <>
                    ...
                    <button
                      ...
                      className="flex min-h-11 w-full items-center gap-2.5 px-3.5 py-2 text-left text-[13px] font-medium text-[#374151] hover:bg-[#F8FAFC] transition"
                    >
                      <svg viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 text-[#C2410C] shrink-0">
                ...
                {canArchive && onArchive && (
                  <>
                    ...
                    <button
                      ...
                      className="flex min-h-11 w-full items-center gap-2.5 px-3.5 py-2 text-left text-[13px] font-medium text-[#64748B] hover:bg-[#F8FAFC] transition"
                    >
                      <svg viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 text-[#94A3B8] shrink-0">
                ...
                {(canGraduate || alreadyGraduated) && onGraduate && (
                  <>
                    ...
                    <button
                      ...
                      className="flex min-h-11 w-full items-center gap-2.5 px-3.5 py-2 text-left text-[13px] font-medium text-[#15803D] hover:bg-[#E7F8EE] transition"
                    >
                      <svg viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 shrink-0">
