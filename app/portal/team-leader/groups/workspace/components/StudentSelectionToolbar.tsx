...
export function StudentSelectionToolbar({
  ...
  return (
    <div className="flex items-center gap-1 rounded-lg border border-[#0E7490]/40 bg-[#FFF7ED] px-2.5 py-1.5 flex-wrap">
      <span className="text-[12px] font-bold text-[#C2410C] mr-1">
        {selectedIds.size} selected
      </span>
      <div className="h-3.5 w-px bg-[#C2410C]/30 mr-0.5" />
      ...
      {waUrl && (
        <a
          ...
          className="flex items-center gap-1 rounded px-2 py-1 text-[12px] font-medium text-[#15803D] hover:bg-[#E7F8EE] transition"
        >
      ...
      {callUrl && (
        <a
          href={callUrl}
          className="flex items-center gap-1 rounded px-2 py-1 text-[12px] font-medium text-[#64748B] hover:bg-white transition"
        >
      ...
      {single && isTL && (
        <button
          ...
          className="flex items-center gap-1 rounded px-2 py-1 text-[12px] font-medium text-[#C2410C] hover:bg-white transition"
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="h-3.5 w-3.5 shrink-0">
        ...
        removeConfirm ? (
          <span className="flex items-center gap-1 ml-1">
            <button
              ...
              className="rounded px-2 py-1 text-[12px] font-semibold text-white bg-[#EF4444] hover:bg-[#DC2626] transition"
            >
          ...
          <button
            ...
            className="flex items-center gap-1 rounded px-2 py-1 text-[12px] font-medium text-[#EF4444] hover:bg-[#FEE2E2] hover:text-[#DC2626] transition"
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="h-3.5 w-3.5 shrink-0">
      ...
      <div className="h-3.5 w-px bg-[#C2410C]/30 ml-0.5" />
