...
function InstructorFormModal({ instructor, options, defaultBranchIds, onClose, onSaved }: {
  ...
  const [branchIds, setBranchIds]       = useState<string[]>(
    instructor?.branch_ids?.length ? instructor.branch_ids : defaultBranchIds.filter(Boolean)
  )
