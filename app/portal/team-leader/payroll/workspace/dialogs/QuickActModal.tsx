        ...
        <Modal onClose={onClose} title={`Add Activity — ${target.display_name}`}>
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label className="text-[13px] font-semibold text-[#0B1F3A]">Activity Type</label>
            ...
            <div>
              <label className="text-[13px] font-semibold text-[#0B1F3A]">Description (optional)</label>
              <input value={qaDesc} onChange={e => setQaDesc(e.target.value)} placeholder="e.g. Group A camp, replace session…"
                className="mt-1 w-full rounded-lg border border-[#E2E8F0] px-3 py-2 text-[13px] focus:outline-none focus:ring-2 focus:ring-[#0E7490]/30" />
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-[13px] font-semibold text-[#0B1F3A]">Rate (EGP)</label>
                <input type="number" min="0" step="50" value={qaRate} onChange={e => setQaRate(e.target.value)} placeholder="0"
                  className="mt-1 w-full rounded-lg border border-[#E2E8F0] px-3 py-2 text-[13px] focus:outline-none focus:ring-2 focus:ring-[#0E7490]/30" />
              </div>
              <div>
                <label className="text-[13px] font-semibold text-[#0B1F3A]">Quantity</label>
            ...
            {qaErr && <p className="text-[13px] text-[#EF4444]">{qaErr}</p>}
