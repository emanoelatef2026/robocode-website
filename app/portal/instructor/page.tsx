      ...
      {pending.length > 0 && (
        <>
          <div className="mb-3 mt-7 flex items-center gap-[10px]">
            <span className="whitespace-nowrap text-[11px] font-bold uppercase tracking-[0.16em] text-[#94A3B8]">
              Pending Reviews
            </span>
            <div className="h-px flex-1 bg-[#eef1f6]" />
            <Link
              href="/portal/instructor/homework"
              className="shrink-0 whitespace-nowrap text-[11px] font-semibold text-[#C2410C] hover:underline"
            >
              View all →
            </Link>
          </div>
          ...
          <div className="ds-card divide-y divide-[#F1F5F9]">
            ...
            {pending.length > 5 && (
              <Link
                href="/portal/instructor/homework"
                className="block px-5 py-2.5 text-xs font-semibold text-[#C2410C] hover:underline"
              >
          ...
          <div className="ds-card divide-y divide-[#F1F5F9]">
            {notificationFeed.notifications.slice(0, 5).map((n) => (
              <Link
                ...
                className="flex items-center gap-3 px-4 py-3 transition hover:bg-[#F8FAFC] md:px-5"
              >
                {!n.is_read && <span className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#C2410C]" />}
                <div className="min-w-0 flex-1">
