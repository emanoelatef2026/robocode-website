      ...
      <div className="px-4 py-4">
        <div className="flex items-start justify-between">
          <div>
            ...
            {item.parent_phone_1 && <p className="text-[13px] text-[#64748B]">{item.parent_phone_1}</p>}
          </div>
    ...
    <>
      {item.parent_phone_1 && (
        <a
          ...
          onClick={logCall}
          className="inline-flex items-center gap-1 rounded-lg bg-[#3B82F6] px-2 py-1 text-[12px] font-bold text-white hover:bg-blue-600"
        >
          📞 Call
        </a>
      )}
      {waLink && (
        <a
          ...
          className="inline-flex items-center gap-1 rounded-lg bg-[#25D366] px-2 py-1 text-[12px] font-bold text-white hover:bg-[#1eb955]"
        >
          💬 WA
        </a>
      )}
      <a
        ...
        className="inline-flex items-center ds-card px-2 py-1 text-[12px] font-medium text-[#64748B] hover:border-[#0E7490] hover:text-[#9A3412]"
      >
        View
      </a>
      <button
        ...
        className="inline-flex items-center ds-card px-2 py-1 text-[12px] font-medium text-[#64748B] hover:border-[#0E7490] hover:text-[#9A3412] disabled:opacity-50"
      >
        {done === 'reminder' ? '✓' : '🔔'}
      </button>
    </>
