  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-[13px] text-gray-400">{bookings.length} total submissions</p>
        </div>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-[13px]">
            ...
            <tbody className="divide-y divide-gray-50">
              {bookings.map((b) => (
                <>
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5 text-gray-500">{b.age ?? "—"}</td>
                    ...
                    <td className="px-5 py-3.5">
                      <svg viewBox="0 0 20 20" fill="currentColor" className={`h-4 w-4 text-gray-300 transition-transform ${expanded === b.id ? "rotate-180" : ""}`}>
                        <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
                      </svg>
                    </td>
                  </tr>
                  {expanded === b.id && (
                    <tr key={`${b.id}-detail`} className="bg-gray-50/40">
                      <td colSpan={7} className="px-5 py-4">
                        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                          {b.school && (
                            <div>
                              <p className="text-[11px] font-semibold uppercase tracking-wide text-gray-400">School</p>
                              <p className="mt-0.5 text-[13px] text-[#0B132B]">{b.school}</p>
                            </div>
                          )}
                          {b.another_phone && (
                            <div>
                              <p className="text-[11px] font-semibold uppercase tracking-wide text-gray-400">Alt Phone</p>
                          ...
                          <div className="sm:col-span-2 lg:col-span-3">
                            <p className="mb-2 text-[11px] font-semibold uppercase tracking-wide text-gray-400">Update Status</p>
                                ...
                                <button
                                  ...
                                  className={`rounded-lg px-3 py-1.5 text-[12px] font-semibold transition ${
                                    b.status === s
                                      ...
                                      : "bg-white text-gray-500 ring-1 ring-gray-200 hover:ring-[#19C6F4] hover:text-[#19C6F4]"
                                  } disabled:opacity-50`}
                                >
              ...
              {bookings.length === 0 && (
                <tr>
                  <td colSpan={7} className="px-5 py-14 text-center text-gray-400">No bookings yet</td>
                </tr>
              )}
            </tbody>
          </table>
