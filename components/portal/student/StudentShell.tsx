          ...
          <TopHeader
            ...
            centerSlot={
              <div className="hidden md:block">
                <p className="text-[20px] font-bold leading-tight tracking-[-0.02em] text-[#0B1F3A]">Hey, {firstName} 👋</p>
                <p className="mt-0.5 text-[13px] font-medium text-[#52677F]" suppressHydrationWarning>
            ...
            quickActions={
              <div className="flex items-center gap-2">
                <div className="flex min-h-10 items-center gap-[7px] rounded-[10px] border border-[#F6E3C4] bg-[#FFF7E6] px-3 py-[7px]">
                  ...
                  <div>
                    ...
                    <div className="text-[11px] font-semibold tracking-[.05em] text-[#B45309]">DAY STREAK</div>
                  </div>
                </div>

                {groupRank != null && (
                  <div className="hidden min-h-10 items-center gap-[7px] rounded-[10px] bg-[#0B1F3A] px-3 py-[7px] md:flex">
                    <span className="text-[14px]" aria-hidden>🏆</span>
                    <div>
                      <div className="text-[14px] font-bold leading-none text-[#FFB15A]" style={{ fontFamily: "var(--font-orbitron)" }}>
                        #{groupRank}
                      </div>
                      <div className="text-[11px] font-semibold text-white/50">IN GROUP</div>
                    </div>
                  </div>
                )}
              </div>
