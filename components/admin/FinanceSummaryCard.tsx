    ...
    <div className="ds-card p-[18px_20px]">
      ...
      <div className="flex items-start justify-between mb-[14px]">
        <div>
          ...
          <p className="mt-[2px] text-[12px] text-[#94A3B8]">Collections snapshot</p>
        </div>
        <Link
          href="/admin/finance"
          className="text-[11.5px] font-semibold text-[#C2410C] hover:text-[#d97706] transition-colors shrink-0"
        >
          View all →
        </Link>
      </div>
      ...
      <div className="mb-[14px]">
        <div className="flex items-center justify-between mb-[6px]">
          <span className="text-[12px] text-[#64748B]">Collection rate this month</span>
          <span className="font-orbitron text-[13px] font-bold text-[#15803D]">{data.collection_rate}%</span>
        </div>
      ...
      <div className="flex flex-col gap-[7px]">
        {data.overdue_count > 0 && (
          ...
          >
            ...
            <span className="font-orbitron text-[13px] font-bold text-[#DC2626] shrink-0">{data.overdue_count}</span>
        ...
        {data.broken_promises > 0 && (
          ...
          >
            ...
            <span className="flex-1 text-[13px] font-medium text-[#B45309]">
              Broken payment promises — parents did not pay as agreed
            </span>
            <span className="font-orbitron text-[13px] font-bold text-[#B45309] shrink-0">{data.broken_promises}</span>
