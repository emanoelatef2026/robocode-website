...
const NAV = [
  ...
  },
  {
    ...
    moreRoutes: [
      "/admin/instructors", "/admin/parents", "/admin/courses", "/admin/assignments",
      "/admin/attendance", "/admin/certificates", "/admin/portfolio", "/admin/communications",
      "/admin/system-health", "/admin/branches", "/admin/team-leaders", "/admin/sessions",
      "/admin/semesters", "/admin/production-readiness", "/admin/analytics", "/admin/payroll",
      "/admin/staff", "/admin/finance", "/admin/executive",
    ],
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
